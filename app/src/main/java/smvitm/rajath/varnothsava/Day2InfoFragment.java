 ...
 */
public class Day2InfoFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            InputStream is;
            String filename;
            is = getActivity().getAssets().open("day2_events.json");
            filename = "dayt_event";
        ...
        final EventScheduleRecyclerViewAdapter itemsAdapter = new EventScheduleRecyclerViewAdapter(Day2InfoFragment.this.getActivity(), pname, null);
        final RecyclerView clv = view.findViewById(R.id.clist);
        clv.setLayoutManager(new LinearLayoutManager(Day2InfoFragment.this.getActivity()));
